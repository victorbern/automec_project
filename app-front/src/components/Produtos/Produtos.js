...
class Produtos extends React.Component {
        ...
        fetch("/api/api/produtos/" + valor, {
            ...
            .then((dados) => {
                ...
                this.setState(() => {
                    return {
                        pageCount: Math.ceil(
                            produtos.length / this.state.perPage
                        ),
    ...
    atualizarProduto = (produto) => {
        fetch("/api/api/produto/" + produto.codigoBarras, {
            method: "PUT",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    atualizarEstoque = (produto) => {
        fetch("/api/api/alterar-estoque/" + produto.codigoBarras, {
            method: "PUT",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                Authorization: "Bearer " + localStorage.getItem("token"),
        ...
        return (
            <div className="container">
                ...
                <ModalIncluir
                    ...
                    atualizaCodigoBarras={this.atualizaCodigoBarras}
                    atualizaDescricao={this.atualizaDescricao}
                    atualizaValorCusto={this.atualizaValorCusto}
                    atualizaQuantidadeEstoque={this.atualizaQuantidadeEstoque}
                ...
                <ModalMovimentar
                    state={this.state}
                    fecharModalMovimentar={this.fecharModalMovimentar}
                    movimentar={this.movimentar}
                    atualizaMovimento={this.atualizaMovimento}
                    movimentarProduto={this.movimentarProduto}
                    atualizaEntradaRadio={this.atualizaEntradaRadio}
                    atualizaSaidaRadio={this.atualizaSaidaRadio}
                />
                <ModalExcluir
                    state={this.state}
