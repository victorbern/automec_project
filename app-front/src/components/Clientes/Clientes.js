        ...
        fetch("http://localhost:3000/api/clientes/" + valor, {
            ...
            .then((dados) => {
                ...
                this.setState(() => {
                    return {
                        pageCount: Math.ceil(
                            clientes.length / this.state.perPage
                        ),
        ...
        return (
            <div className="container">
                ...
                <ModalIncluir
                    ...
                    atualizaCpf={this.atualizaCpf}
                    atualizaCelular={this.atualizaCelular}
                    atualizaTelefone={this.atualizaTelefone}
                    atualizaCep={this.atualizaCep}
                    atualizaEndereco={this.atualizaEndereco}
                    atualizaNumero={this.atualizaNumero}
                    atualizaBairro={this.atualizaBairro}
                    atualizaCidade={this.atualizaCidade}
                    atualizaUf={this.atualizaUf}
