...
class Funcionarios extends React.Component {
        ...
        fetch("/api/api/funcionarios/" + valor, {
            ...
            .then((dados) => {
                ...
                this.setState(() => {
                    return {
                        pageCount: Math.ceil(
                            funcionarios.length / this.state.perPage
                        ),
    ...
    atualizarFuncionario = (funcionario) => {
        fetch("/api/api/funcionario/" + funcionario.idFuncionario, {
            method: "PUT",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                Authorization: "Bearer " + localStorage.getItem("token"),
        ...
        return (
            <div className="container">
                ...
                <ModalIncluir
                    ...
                    atualizaNomeFuncionario={this.atualizaNomeFuncionario}
                    atualizaFuncao={this.atualizaFuncao}
                    atualizaSRadio={this.atualizaSRadio}
                    atualizaNRadio={this.atualizaNRadio}
                />
                <ModalDetalhar
                    state={this.state}
                ...
                <ModalExcluir
                    ...
                    deletarFuncionario={this.deletarFuncionario}
                />
                <Paginator
                    state={this.state}
