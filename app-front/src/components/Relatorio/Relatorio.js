...
class Relatorio extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            emitir: false,
            relatorio: {
                dataDe: "2022-10-15 01:23:38",
                dataAte: "2022-10-22 01:49:59",
            },
            tableData: [
                { id: 1, descricao: "Relatório de Pagamentos por espécie" },
                { id: 2, descricao: "Relatório de Produtos mais vendidos" },
                {
                    id: 3,
                    descricao:
                        "Relatório de Ordem de Serviços pagas e não pagas",
                },
            ],
            orgtableData: [],
            perPage: 10,
            currentPage: 0,
            pageCount: 0,
            column: [{ heading: "Descrição", value: "descricao" }],
        };
    ...
    getPagamentos() {
        ...
        fetch("/api/api/relatorio/pagamentos", {
            method: "POST",
            headers: {
                Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    getProdutos() {
        ...
        fetch("/api/api/relatorio/produtos", {
            method: "POST",
            headers: {
                Authorization: "Bearer " + localStorage.getItem("token"),
                "Content-Type": "application/x-www-form-urlencoded",
    ...
    getOs() {
        ...
        fetch("/api/api/relatorio/ordens-servico", {
            method: "POST",
            headers: {
                Authorization: "Bearer " + localStorage.getItem("token"),
                "Content-Type": "application/x-www-form-urlencoded",
        ...
        return (
            <div className="container">
                ...
                <ModalDetalhar
                    ...
                    atualizaDataDe={this.atualizaDataDe}
                    atualizaDataAte={this.atualizaDataAte}
                    emitir={this.emitir}
                />
                <Paginator
                    state={this.state}
