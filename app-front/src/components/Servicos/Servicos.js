...
class Servicos extends React.Component {
        ...
        fetch("/api/api/servicos/" + valor, {
            ...
            .then((dados) => {
                ...
                this.setState(() => {
                    return {
                        pageCount: Math.ceil(
                            servicos.length / this.state.perPage
                        ),
    ...
    atualizarServico = (servico) => {
        fetch("/api/api/servico/" + servico.idServico, {
            method: "PUT",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                Authorization: "Bearer " + localStorage.getItem("token"),
        ...
        return (
            <div className="container">
                ...
                <ModalIncluir
                    ...
                    atualizaDescricaoServico={this.atualizaDescricaoServico}
                ...
                <ModalExcluir
                    ...
                    deletarServico={this.deletarServico}
                />
                <Paginator
                    state={this.state}
